...
class PostViewTest(BaseAcceptanceTest):
    ...
    def test_index(self):
        ...
        #
        self.assertTrue(b'<a href="http://127.0.0.1:8000/">markdown blog</a>' in response.content)
    ...
    def test_post_page(self):
        ...
        self.assertTrue(b'<a href="http://127.0.0.1:8000/">my first blog post</a>' in response.content)
    ...
    def test_tag_page(self):
        ...
        self.assertTrue(str(post.pub_date.day) in response.content.decode('utf-8'))
        # Check the link is marked up properly
        self.assertTrue('<a href="http://127.0.0.1:8000/">my tagged blog post</a>' in response.content.decode('utf-8'))
